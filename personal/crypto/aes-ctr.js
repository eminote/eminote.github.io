 ...
 *
 * @example
 *   var encr = Aes.Ctr.encrypt('big secret', 'paºšwoøð', 256); // 'lwGl66VVwVObKIr6of8HVqJr'
 */
 ...
 *
 * @example
 *   var decr = Aes.Ctr.decrypt('lwGl66VVwVObKIr6of8HVqJr', 'paºšwoøð', 256); // 'big secret'
 */
 ...
 * - utf8Encode('x') = 'x', but utf8Encode('ça') = 'A§a', and utf8Encode('A§a') = 'AƒÂ§a'*/
